...
resource "local_file" "compose" {
  ...
  filename = "../ansible/roles/deploy_services/files/app-docker-compose.yml"
}
...
resource "local_file" "api_tests_python" {
  ...
  filename = "../ansible/roles/run_tests/files/api_tests.py"
}
...
resource "local_file" "db_tests_python" {
  ...
  filename = "../ansible/roles/run_tests/files/db_tests.py"
}
...
resource "local_file" "infrastructure_tests" {
  ...
  filename = "../ansible/roles/run_tests/files/infrastructure_tests.py"
}
...
resource "local_file" "testing_tasks" {
  ...
  filename = "../ansible/roles/run_tests/tasks/main.yml"
}
...
resource "local_file" "promtail_config" {
  ...
  filename = "../ansible/roles/configure_nginx/files/promtail-config.yml"
}
